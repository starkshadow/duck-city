...
require_once $_SERVER['DOCUMENT_ROOT'] . '/tfe/duck-city/models/BoughtProduct.class.php';
...
header('Location: http://' . $_SERVER['SERVER_NAME'] . '/tfe/duck-city/views/products/macollection.php');
exit();
